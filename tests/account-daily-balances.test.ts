...
test("reconstructs daily account balances from the closing balance", async (t) =>
{
        ...
        const listAccountDailyBalances = mkListAccountDailyBalances(databaseArgs);
        ...
        assert.deepEqual(
                listAccountDailyBalances({
                        ...
                        startDate: parseISO("2026-01-01"),
                        endDate: parseISO("2026-01-05"),
        ...
        assert.deepEqual(listCheckingAccountNegativeBalanceDayCounts(negativeBalanceQuery), [
        ...
        assert.equal(getCheckingAccountNegativeBalanceDayCount(negativeBalanceQuery), 8);
});
