...
test("returns the reliability score response", async (t) => {
    ...
    saveTransactions([transaction("september-income", "2025-09-02", 100, "9001"), transaction("october-income", "2025-10-02", 100, "9001"), transaction("november-income", "2025-11-02", 100, "9001"), transaction("december-income", "2025-12-02", 100, "9001"), transaction("january-income", "2026-01-02", 100, "9001"), transaction("september-savings", "2025-09-03", 10, "6540"), transaction("october-savings", "2025-10-03", 10, "6540"), transaction("november-savings", "2025-11-03", 10, "6540"), transaction("december-savings", "2025-12-03", 10, "6540"), transaction("september-rent", "2025-09-05", -50, "6513"), transaction("october-rent", "2025-10-05", -50, "6513"), transaction("november-rent", "2025-11-05", -50, "6513"), transaction("december-rent", "2025-12-05", -50, "6513"), transaction("january-rent", "2026-01-05", -50, "6513"), transaction("february-rent", "2026-02-05", -50, "6513"), transaction("late-fee", "2026-01-10", -5, "6012"), transaction("high-risk", "2026-02-10", -50, "7995")]);
